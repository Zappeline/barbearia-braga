  ...
  return (
    <div className="min-h-screen bg-surface text-on-surface font-body">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-12 py-12">
        ...
        <button onClick={() => setWalkin(true)} className="w-full mb-8 bg-gradient-to-r from-primary to-primary-container text-on-primary px-4 py-3 rounded-lg font-bold text-xs uppercase tracking-widest active:scale-95 transition-all">
